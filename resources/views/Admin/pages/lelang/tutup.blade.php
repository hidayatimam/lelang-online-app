...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">History Tabel Lelang</h1>
            </div>
          </div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row text-center">
                                    <div class="col-12">
                                        <img src="{{ $petugas->image == null ? asset('image/default.jpg') : asset("profile/$petugas->level").'/'.$petugas->image }}" alt="" class="rounded-circle" style="width:100px;height:100px;">
                                    </div>
                            ...
                            <td><a href="/admin/history_bidding/{{ $row->id_lelang }}">History bidding</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
